...
export const metadata: Metadata = {
  title: "Split AC Rental | Energy Efficient Air Conditioning | ACRentService",
  ...
  alternates: {
    canonical: "https://acrentservice.com/cooling/split-ac",
  },
  openGraph: {
    type: "website",
    url: "https://acrentservice.com/cooling/split-ac",
