...
import { ArrowRight, Leaf, Wind, Zap } from "lucide-react";
  ...
  const subcategories = [
    {
      ...
      description:
        "Compact and affordable cooling solutions perfect for single rooms and small spaces.",
      icon: Wind,
    ...
    },
    {
      ...
      description:
        "Modern, efficient cooling with inverter technology and smart controls for comprehensive comfort.",
      icon: Zap,
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Discover our premium collection of air conditioning units designed
              to keep you cool and comfortable. From compact window units to
              advanced split systems with smart controls, we have the perfect
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 md:p-12 mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  5-star rated units that save up to 40% on electricity bills
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Free expert installation and setup included with every rental
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Round-the-clock customer support and emergency maintenance
                  services available whenever you need us.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Choose from our wide range of air conditioning solutions with
                flexible rental plans starting from just ₹899/month.
              </p>
            </div>
            <div className="flex gap-4 justify-center flex-wrap">
              ...
              <Button
                asChild
                variant="outline"
                className="h-12 px-8 text-base border-2 border-gray-300"
                size="lg"
              >
