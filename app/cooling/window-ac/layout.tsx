...
export const metadata: Metadata = {
  title: "Window AC Rental | Affordable Cooling | ACRentService",
  ...
  alternates: {
    canonical: "https://acrentservice.com/cooling/window-ac",
  },
  openGraph: {
    type: "website",
    url: "https://acrentservice.com/cooling/window-ac",
