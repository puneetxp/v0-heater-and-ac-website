  ...
  const subcategories = [
    {
      ...
      name: "Oil Heaters",
      description:
        "Reliable and efficient oil-filled radiator heaters that provide consistent warmth and comfort during cold winters.",
      icon: Flame,
      ...
      <div className="bg-gradient-to-br from-orange-50 via-orange-50 to-red-50 pt-12 md:pt-20 pb-12 md:pb-20 px-4 md:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="max-w-3xl">
            <Badge className="mb-4 bg-orange-600 text-white px-4 py-1">
              Heating Solutions
            </Badge>
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Stay warm and cozy with our premium heating solutions. Choose from
              reliable oil heaters with various sizes to match your heating
              needs perfectly.
            </p>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-3xl p-8 md:p-12 mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Fast-acting heaters that warm up your space in minutes,
                  providing instant comfort when you need it most.
                </p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-orange-600 text-white mb-4">
                ...
                <p className="text-gray-600">
                  Advanced safety features including tip-over protection and
                  auto shut-off for your complete peace of mind.
                </p>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center h-16 w-16 rounded-full bg-orange-600 text-white mb-4">
                ...
                <p className="text-gray-600">
                  Easy to move between rooms with wheels, making heating
                  flexible for your changing seasonal needs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  name: "7 Fin",
                  space: "Medium rooms (100-200 sq ft)",
                  price: "₹799",
                },
                {
                  name: "9 Fin",
                  space: "Large rooms (200-300 sq ft)",
                  price: "₹999",
                },
                {
                  name: "11 Fin",
                  space: "Extra-large spaces (300+ sq ft)",
                  price: "₹1,299",
                },
              ].map((size, index) => (
                <Card
                  key={index}
                  className="text-center border-0 shadow-lg hover:shadow-xl transition-all rounded-2xl"
                >
          ...
          <div className="text-center space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Rent a high-quality oil heater with flexible plans and enjoy
                warm, comfortable winters without the commitment of buying.
              </p>
            </div>
            <Button
              asChild
              className="bg-orange-600 hover:bg-orange-700 h-12 px-8 text-base"
              size="lg"
            >
